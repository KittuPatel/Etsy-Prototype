...
function removeFavorite(req, res) {
  ...
  try {
    let result = query(
      `DELETE FROM favorites WHERE _id ='${favoriteId}' AND createdBy = '${userId}';`
    )
